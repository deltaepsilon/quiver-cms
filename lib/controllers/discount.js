...
var service = {
    ...
    refresh: function(req, res) {
        ...
        ObjectService.getDiscounts().then(function(trustedCodes) {
            ...
            var unique = _.filter(trustedCodes, function(trustedCode) {
                    ...
                    // Uncomment these lines to force code validation to server. Cart.js no the front end is currently handling duties.
