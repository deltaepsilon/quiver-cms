...
module.exports = {
	...
	getTransaction: function (key, cb) {
		return FirebaseService.getValue(FirebaseService.getTransaction(key));
	},

	getResource: function (key, cb) {
		return FirebaseService.getValue(FirebaseService.getResource(key));
	},
	...
	getUserSubscription: function(userId, key, cb) {
		return FirebaseService.getValue(FirebaseService.getUserSubscription(userId, key));
	},
	...
	getAssignment: function (assignmentKey, cb) {
		return FirebaseService.getValue(FirebaseService.getAssignment(assignmentKey));
	},

	getUserAssignment: function (userId, assignmentKey, cb) {
		return FirebaseService.getValue(FirebaseService.getUserAssignment(userId, assignmentKey));
	},

	getQueuedEmail: function (emailKey, cb) {
		return FirebaseService.getValue(FirebaseService.getQueuedEmail(emailKey));
	}
